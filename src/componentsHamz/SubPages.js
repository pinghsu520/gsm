...
class BoardOfDirectors extends React.Component {
    render() {
        return (
            ...
            <p className="jumbotron">
            <h1 className="display-4">Good They Are Doing </h1>
            ...
            <p className="jumbotron">
            <h1 className="display-4">Good They Are Doing </h1>
            <img src="/images/image-4.jpg" class="ui fluid image" />
            <hr className="my-4"></hr>
            <p id="sub-text">It uses utility classes for typography and spacing to space content out within the larger container.</p>
            <a className="btn btn-primary btn-lg" href="/responsibility" role="button">Learn more</a>
          </p>
          <p className="jumbotron">
          <h1 className="display-4">Non Profit Presentation</h1>
          <img src="/images/image-2.jpg" class="ui fluid image" />
          <hr className="my-4"></hr>
          <p id="sub-text">It uses utility classes for typography and spacing to space content out within the larger container.</p>
          <a className="btn btn-primary btn-lg" href="/non_profit_representation" role="button">Learn more</a>
        </p>
        <p className="jumbotron">
        ...
        <hr className="my-4"></hr>
        <p id="sub-text">It uses utility classes for typography and spacing to space content out within the larger container.</p>
        <a className="btn btn-primary btn-lg" href="/social_impact" role="button">Learn more</a>
      </p>
<p className="jumbotron">
            ...
            <hr className="my-4"></hr>
            <p id="sub-text">It uses utility classes for typography and spacing to space content out within the larger container.</p>
            <a className="btn btn-primary btn-lg" href="/why_non_profit" role="button">Learn more</a>
          </p>
            </div>
